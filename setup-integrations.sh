...
echo -e "${YELLOW}🌐 Setting up Solyn.org domain...${NC}"
echo ""
echo "In your Vercel dashboard:"
echo "1. Go to your project settings"
echo "2. Navigate to 'Domains' section"
echo "3. Add 'solyn.org' as a custom domain"
echo "4. Add 'www.solyn.org' as well"
echo ""
...
echo "• https://solyn.org"
echo "• https://www.solyn.org"
echo ""
